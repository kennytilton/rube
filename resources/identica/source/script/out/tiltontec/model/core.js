...
var len__5593__auto___27203 = arguments.length;
var i__5594__auto___27204 = (0);
while(true){
if((i__5594__auto___27204 < len__5593__auto___27203)){
args__5600__auto__.push((arguments[i__5594__auto___27204]));

var G__27205 = (i__5594__auto___27204 + (1));
i__5594__auto___27204 = G__27205;
continue;
} else {
}
break;
...
var me = cljs.core.atom.call(null,cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"par","par",-61778778),tiltontec.model.family._STAR_par_STAR_], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__27195){
...
return (function (p__27201){
var vec__27202 = p__27201;
var slot = cljs.core.nth.call(null,vec__27202,(0),null);
...
tiltontec.model.core.make.cljs$lang$applyTo = (function (seq27194){
return tiltontec.model.core.make.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27194));
});
