...
var len__5593__auto___15385 = arguments.length;
var i__5594__auto___15386 = (0);
while(true){
if((i__5594__auto___15386 < len__5593__auto___15385)){
args__5600__auto__.push((arguments[i__5594__auto___15386]));

var G__15387 = (i__5594__auto___15386 + (1));
i__5594__auto___15386 = G__15387;
continue;
} else {
}
break;
...
var me = cljs.core.atom.call(null,cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"par","par",-61778778),tiltontec.model.family._STAR_par_STAR_], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__15377){
...
}),cljs.core.filter.call(null,(function (p__15379){
var vec__15380 = p__15379;
var slot = cljs.core.nth.call(null,vec__15380,(0),null);
...
return (function (p__15383){
var vec__15384 = p__15383;
var slot = cljs.core.nth.call(null,vec__15384,(0),null);
var v = cljs.core.nth.call(null,vec__15384,(1),null);
...
tiltontec.model.core.make.cljs$lang$applyTo = (function (seq15376){
return tiltontec.model.core.make.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15376));
});
