...
tiltontec.util.core.rmap_setf = (function tiltontec$util$core$rmap_setf(p__21951,new_value){
var vec__21953 = p__21951;
var slot = cljs.core.nth.call(null,vec__21953,(0),null);
var ref = cljs.core.nth.call(null,vec__21953,(1),null);
...
tiltontec.util.core.rmap_meta_setf = (function tiltontec$util$core$rmap_meta_setf(p__21954,new_value){
var vec__21956 = p__21954;
var slot = cljs.core.nth.call(null,vec__21956,(0),null);
var ref = cljs.core.nth.call(null,vec__21956,(1),null);
...
return (function() { 
var G__21957__delegate = function (a1,args){
return cljs.core.fn_QMARK_.call(null,a1);
};
var G__21957 = function (a1,var_args){
var args = null;
...
while (G__21958__i < G__21958__a.length) {G__21958__a[G__21958__i] = arguments[G__21958__i + 1]; ++G__21958__i;}
  args = new cljs.core.IndexedSeq(G__21958__a,0);
} 
return G__21957__delegate.call(this,a1,args);};
G__21957.cljs$lang$maxFixedArity = 1;
G__21957.cljs$lang$applyTo = (function (arglist__21959){
var a1 = cljs.core.first(arglist__21959);
var args = cljs.core.rest(arglist__21959);
return G__21957__delegate(a1,args);
});
...
while (G__21961__i < G__21961__a.length) {G__21961__a[G__21961__i] = arguments[G__21961__i + 1]; ++G__21961__i;}
  mas = new cljs.core.IndexedSeq(G__21961__a,0);
} 
return G__21960__delegate.call(this,fn,mas);};
G__21960.cljs$lang$maxFixedArity = 1;
G__21960.cljs$lang$applyTo = (function (arglist__21962){
var fn = cljs.core.first(arglist__21962);
var mas = cljs.core.rest(arglist__21962);
return G__21960__delegate(fn,mas);
});
...
var G__21963__delegate = function (bits){
...
while (G__21964__i < G__21964__a.length) {G__21964__a[G__21964__i] = arguments[G__21964__i + 0]; ++G__21964__i;}
  bits = new cljs.core.IndexedSeq(G__21964__a,0);
} 
return G__21963__delegate.call(this,bits);};
G__21963.cljs$lang$maxFixedArity = 0;
G__21963.cljs$lang$applyTo = (function (arglist__21965){
var bits = cljs.core.seq(arglist__21965);
return G__21963__delegate(bits);
});
...
var _STAR_trxdepth_STAR_21967 = tiltontec.util.base._STAR_trxdepth_STAR_;
...
}finally {tiltontec.util.base._STAR_trxdepth_STAR_ = _STAR_trxdepth_STAR_21967;
}});
...
var result__21689__auto__ = cljs.core.first.call(null,cljs.core.deref.call(null,q));
