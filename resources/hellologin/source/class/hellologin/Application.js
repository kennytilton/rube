...
/**
 * This is the main application class of your custom application "hellologin"
 *
 * @asset(hellologin/*)
 */
qx.Class.define("hellologin.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      var login = new hellologin.page.Login();
      var overview = new hellologin.page.Overview();
