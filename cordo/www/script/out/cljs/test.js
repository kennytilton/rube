...
var args459836 = [];
var len__7285__auto___459840 = arguments.length;
var i__7286__auto___459841 = (0);
while(true){
if((i__7286__auto___459841 < len__7285__auto___459840)){
args459836.push((arguments[i__7286__auto___459841]));

var G__459842 = (i__7286__auto___459841 + (1));
i__7286__auto___459841 = G__459842;
continue;
} else {
}
break;
...
var G__459838 = args459836.length;
switch (G__459838) {
case 0:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args459836.length)].join('')));
...
var G__459839 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__459839__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__459839,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__459839);
return G__459839__$1;
});
...
var len__7285__auto___459847 = arguments.length;
var i__7286__auto___459848 = (0);
while(true){
if((i__7286__auto___459848 < len__7285__auto___459847)){
args__7292__auto__.push((arguments[i__7286__auto___459848]));

var G__459849 = (i__7286__auto___459848 + (1));
i__7286__auto___459848 = G__459849;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq459844){
var G__459845 = cljs.core.first.call(null,seq459844);
var seq459844__$1 = cljs.core.next.call(null,seq459844);
var G__459846 = cljs.core.first.call(null,seq459844__$1);
var seq459844__$2 = cljs.core.next.call(null,seq459844__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__459845,G__459846,seq459844__$2);
});
...
var map__459853 = m;
var map__459853__$1 = ((((!((map__459853 == null)))?((((map__459853.cljs$lang$protocol_mask$partition0$ & (64))) || (map__459853.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__459853):map__459853);
var file = cljs.core.get.call(null,map__459853__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__459853__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__459853__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__459853,map__459853__$1,file,line,column){
return (function (p1__459850_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__459850_SHARP_));
});})(map__459853,map__459853__$1,file,line,column))
...
var temp__4425__auto___459855 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___459855)){
var message_459856 = temp__4425__auto___459855;
cljs.core.println.call(null,message_459856);
} else {
}
...
var temp__4425__auto___459857 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___459857)){
var message_459858 = temp__4425__auto___459857;
cljs.core.println.call(null,message_459858);
} else {
}
...
var G__459868 = exception.stack;
var G__459868__$1 = (((G__459868 == null))?null:clojure.string.split_lines.call(null,G__459868));
var G__459868__$2 = (((G__459868__$1 == null))?null:cljs.core.get.call(null,G__459868__$1,depth));
var G__459868__$3 = (((G__459868__$2 == null))?null:clojure.string.trim.call(null,G__459868__$2));
return G__459868__$3;
} else {
...
var vec__459869 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__459869,(0),null);
var column = cljs.core.nth.call(null,vec__459869,(1),null);
var vec__459872 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__459872,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__459872,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__459872,(2),null);
...
var m__$1 = (function (){var G__459876 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__459876) {
case "fail":
...
var G__459882 = (function (){var G__459881 = cljs.core.rest.call(null,fns);
var G__459881__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__459881):G__459881);
return G__459881__$1;
})();
fns = G__459882;
continue;
}
...
var G__459884 = fns;
var G__459884__$1 = (((G__459884 == null))?null:cljs.core.vary_meta.call(null,G__459884,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__459884__$1;
});
...
}catch (e459887){var e = e459887;
var G__459888 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__459888) {
...
var vec__459893 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__459893,(0),null);
var types = vec__459893;
...
return cljs.core.map.call(null,(function (p__459905){
var vec__459906 = p__459905;
var ns = cljs.core.nth.call(null,vec__459906,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__459906,(1),null);
return ((function (vec__459906,ns,vars__$1){
return (function (){
...
var G__459909 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__459909) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1){
return (function (){
var seq__459910 = cljs.core.seq.call(null,vars__$1);
var chunk__459911 = null;
var count__459912 = (0);
var i__459913 = (0);
while(true){
if((i__459913 < count__459912)){
var v = cljs.core._nth.call(null,chunk__459911,i__459913);
var temp__4425__auto___459915 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___459915)){
var t_459916 = temp__4425__auto___459915;
each_fixture_fn.call(null,((function (seq__459910,chunk__459911,count__459912,i__459913,t_459916,temp__4425__auto___459915,v,each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_459916)));
});})(seq__459910,chunk__459911,count__459912,i__459913,t_459916,temp__4425__auto___459915,v,each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1))
);
} else {
}

var G__459917 = seq__459910;
var G__459918 = chunk__459911;
var G__459919 = count__459912;
var G__459920 = (i__459913 + (1));
seq__459910 = G__459917;
chunk__459911 = G__459918;
count__459912 = G__459919;
i__459913 = G__459920;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__459910);
if(temp__4425__auto__){
var seq__459910__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__459910__$1)){
var c__7021__auto__ = cljs.core.chunk_first.call(null,seq__459910__$1);
var G__459921 = cljs.core.chunk_rest.call(null,seq__459910__$1);
var G__459922 = c__7021__auto__;
var G__459923 = cljs.core.count.call(null,c__7021__auto__);
var G__459924 = (0);
seq__459910 = G__459921;
chunk__459911 = G__459922;
count__459912 = G__459923;
i__459913 = G__459924;
continue;
} else {
var v = cljs.core.first.call(null,seq__459910__$1);
var temp__4425__auto___459925__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___459925__$1)){
var t_459926 = temp__4425__auto___459925__$1;
each_fixture_fn.call(null,((function (seq__459910,chunk__459911,count__459912,i__459913,t_459926,temp__4425__auto___459925__$1,v,seq__459910__$1,temp__4425__auto__,each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_459926)));
});})(seq__459910,chunk__459911,count__459912,i__459913,t_459926,temp__4425__auto___459925__$1,v,seq__459910__$1,temp__4425__auto__,each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1))
);
} else {
}

var G__459927 = cljs.core.next.call(null,seq__459910__$1);
var G__459928 = null;
var G__459929 = (0);
var G__459930 = (0);
seq__459910 = G__459927;
chunk__459911 = G__459928;
count__459912 = G__459929;
i__459913 = G__459930;
continue;
}
} else {
...
});})(each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1))
);
});})(each_fixture_fn,G__459909,env,once_fixtures,each_fixtures,vec__459906,ns,vars__$1))
], null);
